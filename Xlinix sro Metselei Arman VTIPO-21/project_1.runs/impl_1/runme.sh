...
HD_PWD='C:/Users/krist/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_noa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block_noa.tcl -notrace
