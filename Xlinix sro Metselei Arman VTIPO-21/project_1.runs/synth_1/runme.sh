...
HD_PWD='C:/Users/krist/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_noa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_noa.tcl
